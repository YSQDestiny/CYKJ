...
<body class="mdui-drawer-body-left mdui-appbar-with-toolbar mdui-loaded mdui-theme-primary-indigo mdui-theme-accent-pink">
    ...
    <div class="mdui-container doc-container">
        <table id="dg" title="区域" class="easyui-datagrid" style="width:100%;height:500px"
               url="${path}options/getAll"
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px"
        ...
        <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
            ...
            <div style="margin-bottom:10px">
                <input name="name" class="easyui-textbox" required="true" label="选项:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
                <input name="area" class="easyui-textbox" required="true" label="所属区域:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
                <input name="industry" class="easyui-textbox" required="true" label="所属行业:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
                <input name="insuranceType" class="easyui-textbox" required="true" label="险种:" style="width:100%">
            </div>
        </form>
    </div>
    <div id="dlg-buttons">
