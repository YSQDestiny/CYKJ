...
<div class="mdui-container doc-container">
    <table id="dg" title="评定内容" class="easyui-datagrid" style="width:100%;height:500px"
           url="${path}property/getAllOptions"
           toolbar="#toolbar" pagination="true"
           rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
        <tr>
            <th field="name" width="75">评定内容</th>
