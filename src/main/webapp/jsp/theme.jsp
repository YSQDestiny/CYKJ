...
<div class="mdui-dialog mdui-dialog-open" id="dialog-docs-theme" style="display: none; top: 68.1795px; height: 772.641px;">
    <div class="mdui-dialog-title">设置文档主题</div>
    <div class="mdui-dialog-content" style="height: 652.641px;">
        ...
        <form class="mdui-row-xs-1 mdui-row-sm-2 mdui-row-md-3">
            ...
            <div class="mdui-col mdui-text-color-blue">
                <label class="mdui-radio mdui-m-b-1">
                    <input type="radio" name="doc-theme-primary" value="blue" checked="">
                    <i class="mdui-radio-icon"></i>
                    Blue
                </label>
            </div>
